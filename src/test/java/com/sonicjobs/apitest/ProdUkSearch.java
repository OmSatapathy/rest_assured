...
public class ProdUkSearch extends BaseUrl {

	@Test(dependsOnMethods = { "loginExistinguserUk" })
	public void oldSearch() {
		...
		given().contentType("application/json").header("AUTH-TOKEN", jobseekerToken).body(obj.toString())
				.post(prodBaseurlUk + "/search/jobs/0/0?micro=Test&macro=Other").then().statusCode(200)
	...
	public void newSearch() {
		given().contentType("application/json").header("AUTH-TOKEN", jobseekerToken2).get(prodBaseurlUk
